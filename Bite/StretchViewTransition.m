...
@implementation StretchViewTransition
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    {
        CGFloat size = MAX(CGRectGetHeight(transitionContext.containerView.frame), CGRectGetWidth(transitionContext.containerView.frame)) * 9.2;
    ...
    if(!self.isReverse){
        ...
        [UIView transitionWithView:animatedViewForTransition
                          duration:[self transitionDuration:transitionContext] * 1.1
                           options:0
                        animations:^{
        ...
        //        [UIView animateWithDuration:[self transitionDuration:transitionContext] * 0.92
        //                              delay:[self transitionDuration:transitionContext] * 0
        //                            options:0
        //                         animations:^{
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, NSEC_PER_SEC * [self transitionDuration:transitionContext] * .18), dispatch_get_main_queue(), ^{
            [UIView transitionWithView:animatedViewForTransition
                              duration:[self transitionDuration:transitionContext] * .68
                               options:0
                            animations:^{
